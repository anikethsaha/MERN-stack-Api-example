...
var _userform = __webpack_require__(18);

var _userform2 = _interopRequireDefault(_userform);

var _userdiv = __webpack_require__(17);

var _userdiv2 = _interopRequireDefault(_userdiv);
...
var Body = function (_React$Component) {
  ...
  function Body(props) {
    ...
    _this.handleRemoveFakeUserPanel = _this.handleRemoveFakeUserPanel.bind(_this);
    _this.state = { user: [] };

    console.log(_this.props.s_key);
    console.log("insied the body component", _this.props.store);
  ...
  _createClass(Body, [{
    ...
    value: function componentWillMount() {
      ...
      fetch('/api/get/all').then(function (res) {
        return res.json();
      }).then(function (users) {
    ...
    key: 'handleRemoveFakeUserPanel',
    value: function handleRemoveFakeUserPanel(e) {
      // console.log(e);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement('input', { type: 'text', name: '', className: 'u-full-width', onChange: this.props.ChangeName }),
              _react2.default.createElement(
                'button',
                { type: 'button', className: ' btn', name: 'button' },
                'Search'
              )
            ),
            _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'right_adduser_panel' },
          _react2.default.createElement(
            'span',
            { className: 'close-btn', onClick: this.handleRemoveFakeUserPanel },
            '\u2715'
          ),
          _react2.default.createElement(
            'div',
            { className: 'right_panel_details' },
            _react2.default.createElement(
              'h3',
              null,
              'Write Anything fake But valid ',
              _react2.default.createElement(
                'strong',
                null,
                '\u263A'
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'btn', onClick: this.handleAction },
              'click '
            ),
            this.store.getState().user.map(function (u) {
              return _react2.default.createElement(_userdiv2.default, { name: u.name, age: u.age, location: u.location, gender: u.gender, job: u.job });
            })
          )
        )
      );
...
var Header = function (_React$Component) {
  ...
  function Header() {
    ...
    _this.handleAddFakeUserPanel = _this.handleAddFakeUserPanel.bind(_this);
    _this.state = { isPanelBtnClicked: false };
    return _this;
  }

  _createClass(Header, [{
    key: 'handleAddFakeUserPanel',
    value: function handleAddFakeUserPanel(e) {
      console.log(e);
      $('.right_adduser_panel').toggleClass('open');
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'five columns adduser_lnk_btn' },
              _react2.default.createElement(
                'a',
                { className: 'btn', onClick: this.handleAddFakeUserPanel },
                'Add Fake User '
              )
            )
          )
...
var UserDiv = function (_React$Component) {
  _inherits(UserDiv, _React$Component);

  function UserDiv() {
    _classCallCheck(this, UserDiv);

    return _possibleConstructorReturn(this, (UserDiv.__proto__ || Object.getPrototypeOf(UserDiv)).call(this));
  }

  _createClass(UserDiv, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        "div",
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement("img", { src: "./public/image/66468562db3b343617b4912256cad666.png" })
          ),
          _react2.default.createElement(
            "div",
...
var UserForm = function (_React$Component) {
  ...
  function UserForm() {
    ...
    return _possibleConstructorReturn(this, (UserForm.__proto__ || Object.getPrototypeOf(UserForm)).call(this));
  }
  ...
  _createClass(UserForm, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "form",
        { className: "userform", action: "/api/user/insert", method: "post" },
        _react2.default.createElement("input", { type: "text", name: "name", placeholder: "Write the name" }),
        _react2.default.createElement("input", { type: "text", name: "location", placeholder: "Write the Location" }),
        _react2.default.createElement("input", { type: "number", name: "age", placeholder: "Age" }),
        _react2.default.createElement("input", { type: "text", name: "gender", placeholder: "Gender" }),
        _react2.default.createElement("input", { type: "text", name: "job", placeholder: "Job" }),
        _react2.default.createElement(
          "button",
          { type: "submit", name: "button", className: "btn" },
          "Submit"
        )
      );
    }
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(5);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(7);var _assign=__webpack_require__(4);var emptyFunction=__webpack_require__(2);var checkPropTypes=__webpack_require__(11);var getActiveElement=__webpack_require__(9);var shallowEqual=__webpack_require__(10);var containsNode=__webpack_require__(8);var emptyObject=__webpack_require__(3);var hyphenateStyleName=__webpack_require__(22);var camelizeStyleName=__webpack_require__(20);/**
...
var Layout = function (_React$Component) {
  ...
  function Layout(props) {
    ...
    _this.actionChange = _this.actionChange.bind(_this);
    _this.handleChangeName = _this.handleChangeName.bind(_this);
    _this.state = { inputkey: "" };
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_body2.default, { ChangeName: this.handleChangeName, store: this.store, s_key: this.state.inputkey }),
        _react2.default.createElement(
          'a',
...
var renderAll = function renderAll() {
  _reactDom2.default.render(_react2.default.createElement(Layout, { store: store }), document.getElementById('root'));
};
renderAll();
